...
# # listaclon = []
# # for i in listaOrigi:
# #     agregar = input("escibre otros atirculos (Salir para salir)")
    
# #     if agregar.lower() == "salir":
# #         break
# #     else:
# #         listaclon.append(agregar)
# #         #se valida que ambas listas sean de tipo str
# #         listaclon = [str(x) for x in listaclon]

# # candidatos = int(input("cual es la cantidad de datos que quiere ver"))
# # listaOrigi.extend(listaclon)
# # listaOrigi.sort()

# # for i in listaOrigi[:candidatos]:
# #     print(i)
...
#     print("Eliminando valores no válidos (None o negativos)...")

#     depurada = []      # Lista temporal sin los valores malos
#     removidos = 0      # Contador total de elementos eliminados

#     for v in ventas:
#         if v is None or v < 0:
#             print(f" - Valor eliminado por no válido: {v}")
#             removidos += 1
#         else:
#             depurada.append(v)

#     print("Lista luego de eliminar inválidos:", depurada)

#     print("Eliminando repeticiones que superan el umbral...")

#     final = []      # Lista ya depurada completamente
...
#             conteo[v] += 1
#         else:
#             print(f" - Valor '{v}' eliminado por exceder el umbral ({umbral})")
#             removidos += 1

#     print("Lista final depurada:", final)
#     print("Cantidad de elementos removidos:", removidos)

#     return final

# ventas = [10, 20, None, 20, 20, 20, -5, 10, 10, 15]
# umbral = 2

# resultado = depurar_ventas(ventas, umbral)
